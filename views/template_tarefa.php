<html>
    ...
    <body>
        <h1>Tarefa: <?php echo htmlentities($tarefa->getTarefa()); ?></h1>

        <p><a href="index.php?rota=tarefas">Voltar para a lista de tarefas</a>.</p>

        <p><strong>Concluída:</strong> <?php echo traduz_concluida($tarefa->getConcluido()); ?></p>
                ...
                <?php foreach ($tarefa->getAnexos() as $anexo) : ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="index.php?rota=remover_anexo&id=<?php echo $anexo->getId()?>&page=<?php echo $tarefa->getId()?>">Remover</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </table>
